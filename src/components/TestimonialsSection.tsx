...
const googleReviews: Testimonial[] = [
  ...
  { patient_name: 'Divya T',    rating: 5, review: 'Dr. Vishali is an amazing pediatrician. Very patient with children and parents. My son actually looks forward to his check-ups now!',            doctor: 'Dr. Vishali G',       review_date: '2 months ago', source: 'google' },
