...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden bg-gradient-to-br from-[#e8f8f9] via-[#f0f9ff] to-[#e8f5e9]">
      ...
      {/* Flash News Ticker — displayed prominently below navbar within the hero */}
      <FlashTicker />

      <div className="flex-1 flex items-center">
        <div className="max-w-7xl mx-auto px-4 pt-16 pb-16 w-full">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="animate-fade-up">
                ...
                <p className="mt-4 text-gray-600 text-lg leading-relaxed max-lg">
            ...
            {/* Right — Hero Banner + floating rating card */}
